...
class BTFBS(nn.Module):
    def __init__(self, hp,
                 protein_MAX_LENGH=600,
                 drug_MAX_LENGH=100):
        super(BTFBS, self).__init__()
        ...
        self.drug_vocab_size = 500
        self.protein_vocab_size = 13000
    ...
    def forward(self, drug, protein):
        ...
        # [F_C, B, D_C] -> [F_C, B, D_C]
        # [T_C, B, D_C] -> [T_C, B, D_C]
        # drug_att, drug_att1 = self.mix_attention_layer(drug_QKV, protein_QKV, protein_QKV)
        # protein_att, _ = self.mix_attention_layer(protein_QKV, drug_QKV, drug_QKV)
        drug_att, drug_att1 = self.mix_attention_layer(drug_QKV, drug_QKV, drug_QKV)
