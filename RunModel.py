...
def run_model(SEED, DATASET, MODEL, K_Fold, LOSS):
    ...
    '''metrics'''
    F1_List_stable, ACC_List_stable, Sensitivity_List_stable, Specificity_List_stable, MCC_List_stable = [], [], [], [], []
    ...
    for i_fold in range(K_Fold):
        ...
        testset_test_stable_results, F1_test, ACC_test, Sensitivity_test, Specificity_test, MCC_test = test_model(
    ...
    show_result(DATASET, F1_List_stable, ACC_List_stable,
                Sensitivity_List_stable, Specificity_List_stable, MCC_List_stable, Ensemble=False)
